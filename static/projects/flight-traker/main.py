...
dest_email = "buriganasergio@gmail.com"
my_email = 'filippo.marini6789@gmail.com'
password = 'sadqlvrwwoqotdtu'
now = dt.datetime.now()
weekday = now.weekday()
...
for i in range(0, length_of_sheet):
    if sheet_data['sheet1'][i]["iataCode"] == "":
        ...
        if price <= lowest_price:
            ...
            notification.send_email(dest_email, my_email, password, dep_city, dep_airport, ar_city, ar_airport, price, first_day, last_day)
